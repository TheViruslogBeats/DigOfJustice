  ...
  return (
    ...
    >
      ...
      <div className="mx-auto">
        <div>
          <Image alt="kek" src={Svg1.src} width={62} height={100} />
          <h3>
            Обсуждение проблем и перспектив информационной безопасности
            правосудия, цифровизации судебной деятельности, концепции и
            технологий машиночитаемого права, определение векторных направлений
            междисциплинарных исследований.
          </h3>
        </div>
        <div>
          <Image alt="kek" src={Svg2.src} width={68} height={100} />
          <h3>
        ...
        <div>
          <Image alt="kek" src={Svg3.src} width={100} height={100} />
          <h3>
            Обмен опытом в вопросах разработки проектов платформенных решений в
            судебной деятельности.
          </h3>
        </div>
        <div>
          <Image alt="kek" src={Svg4.src} width={66} height={100} />
          <h3>
            Стимулирование междисциплинарных исследований как одного из
            стратегических направлений программы стратегического академического
            лидерства «Приоритет -2030».
          </h3>
        </div>
        <div>
          <Image alt="kek" src={Svg5.src} width={100} height={100} />
          <h3>
