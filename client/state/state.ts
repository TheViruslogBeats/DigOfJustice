...
//Компоненты секций
export const sectionListArray: SectionListType[][] = [
  [
    {
      id: 0,
...
//Кнопки секций
export const sectionButtonsArray: SectionButtonsType[] = [
  {
    id: 0,
...
//Основная программа
export const programsArray: programsType[] = [
  {
    id: 0,
